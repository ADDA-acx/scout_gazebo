...
struct GPSStatus_
{
  ...
  _satellites_used_type satellites_used;
   ...
   typedef std::vector<int32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int32_t>> _satellite_used_prn_type;
  ...
  _satellites_visible_type satellites_visible;
   ...
   typedef std::vector<int32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int32_t>> _satellite_visible_prn_type;
  _satellite_visible_prn_type satellite_visible_prn;

   typedef std::vector<int32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int32_t>> _satellite_visible_z_type;
  _satellite_visible_z_type satellite_visible_z;

   typedef std::vector<int32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int32_t>> _satellite_visible_azimuth_type;
  _satellite_visible_azimuth_type satellite_visible_azimuth;

   typedef std::vector<int32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int32_t>> _satellite_visible_snr_type;
